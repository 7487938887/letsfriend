...
@section('content')
    ...
    <form method="POST" action="{{route('posts.create')}}">
        ...
        <div class="form-group">
            ...
            <input type="text" class="form-control" name="author" id="author" value="{{$post->profile->name}}">
        </div>

        <div class="form-group">
            <label for="author_email">Author Email</label>
            <input type="text" class="form-control" name="author_email" id="author_email" value="{{$post->profile->email}}">
        </div>
